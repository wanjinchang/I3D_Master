...
from models.I3D_Net import I3D_Net
...
# Inception module (Inc.) parameters --> dict, each key denotes the parameters of the four branches
# e.g. 'Inc_1': {'Branch_0': [out_channels, ksize], 'Branch_1': [out_channels_1, ksize_1, out_channels_2, ksize_2],
# 'Branch_2': [out_channels_1, ksize_1, out_channels_2, ksize_2], 'Branch_3': [pool_ksize,
# pool_strides, out_channles, ksize]}
# the Inception module (Inc.) architecture can get in the paper: https://arxiv.org/pdf/1705.07750.pdf
Inc_params = {'Inc_1': {'Branch_0': [64, 1], 'Branch_1': [96, 1, 128, 3], 'Branch_2': [16, 1, 32, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 32, 1]},
              'Inc_2': {'Branch_0': [128, 1], 'Branch_1': [128, 1, 192, 3], 'Branch_2': [32, 1, 96, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 64, 1]},
              'Inc_3': {'Branch_0': [192, 1], 'Branch_1': [96, 1, 208, 3], 'Branch_2': [16, 1, 48, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 64, 1]},
              'Inc_4': {'Branch_0': [160, 1], 'Branch_1': [112, 1, 224, 3], 'Branch_2': [24, 1, 64, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 64, 1]},
              'Inc_5': {'Branch_0': [128, 1], 'Branch_1': [128, 1, 256, 3], 'Branch_2': [24, 1, 64, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 64, 1]},
              'Inc_6': {'Branch_0': [112, 1], 'Branch_1': [144, 1, 288, 3], 'Branch_2': [32, 1, 64, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 64, 1]},
              'Inc_7': {'Branch_0': [256, 1], 'Branch_1': [160, 1, 320, 3], 'Branch_2': [32, 1, 128, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 128, 1]},
              'Inc_8': {'Branch_0': [256, 1], 'Branch_1': [160, 1, 320, 3], 'Branch_2': [32, 1, 128, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 128, 1]},
              'Inc_9': {'Branch_0': [384, 1], 'Branch_1': [192, 1, 384, 3], 'Branch_2': [48, 1, 128, 3],
                        'Branch_3': [[1, 3, 3, 3, 1], [1, 1, 1, 1, 1], 128, 1]},
              }
...
if __name__ == '__main__':
    ...
    help='Test model for required video if pretrained model exists.')
    parser.add_argument(
    '--dataset', '-ds', type=str,
